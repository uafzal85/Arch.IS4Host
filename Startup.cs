...
namespace Arch.IS4Host
{
    public class Startup
    {
        ...
        {   
            // store connection string in a var
            var connectionString = Configuration.GetConnectionString("DefaultConnection");

            // store assembly for migations
            var migrationsAssembly = typeof(Startup).GetTypeInfo().Name;

            // replace dbcontext from Sqlite to Postgres
